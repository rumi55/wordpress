...
<div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <h3>Téléphone :</h3> +33 (0)1 77 32 88 46            
        </div>
        <div class="span6">
            ...
            <h3>E-mail :</h3> contact@savemysmartphone.fr
            <h3>Site Web :</h3> www.savemysmartphone.fr
        </div>           
    </div>

        <h3 class="contact-title">Contactez-nous</h3>
        <form class="contact" method="post" action="email.php" enctype="multipart/form-data" name="Contactform" id="contactform">                                 
            <input type="text" id="name" name="name" placeholder="NON Prenom" >                 
